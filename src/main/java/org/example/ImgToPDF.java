...
public class ImgToPDF {
    public static void main(String[] args) throws MalformedURLException, IOException {
        String dest = "src/main/resources/pdf/book_table1.pdf";
    ...
    public void createPdf(String dest) throws MalformedURLException, IOException {
        ...
        try {
            headerFont = PdfFontFactory.createFont("src/main/resources/font/NanumGothicLight.ttf", "Identity-H");
            bodyFont = PdfFontFactory.createFont("src/main/resources/font/NanumPenScript-Regular.ttf", "Identity-H");
        } catch (IOException e) {
            e.printStackTrace();
        }

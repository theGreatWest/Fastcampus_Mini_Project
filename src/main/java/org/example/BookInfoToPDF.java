...
public class BookInfoToPDF {
    public static void main(String[] args) {
        ...
        try {
            ...
            PdfWriter writer = new PdfWriter(new FileOutputStream("src/main/resources/pdf/book_information1.pdf"));
            ...
            // 폰트 생성 및 추가
            // 구글 폰트: https://fonts.google.com/ 다운로드
            PdfFont font = PdfFontFactory.createFont("src/main/resources/font/NanumPenScript-Regular.ttf", PdfEncodings.IDENTITY_H);
